...
document drafting, and professional correspondence.`,
    ...
    screenshots: [
      { src: '/clinical-research-assistant/screenshot_1.png', caption: 'The user prompts the Agent with details for their clinical research' },
      { src: '/clinical-research-assistant/screenshot_2.png', caption: 'The Agent replies with questions and clarfications, based on SOTA LLM understanding of clinical trials' },
      { src: '/clinical-research-assistant/screenshot_3.png', caption: 'Before any permanent or major implementations, the Agent asks for approval and accepts feedback from users for its plan of actions' },
    ],
    status: 'Live',
    featured: false,
  },
